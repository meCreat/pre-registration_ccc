$(document).ready(function(){
	...
	$('#submit').on('click',function(){
		...
		"#rd9",'#rd10',"#rd11","#rd12","#rd13","#rd14","#rd15","#rd16","#rd17"];
		...
		console.log(c_sname,c_fname,c_mname,c_dept,c_add ,c_house,c_course,c_year_lvl,c_con, c_st, c_brgy, c_city,c_bplace,c_gender,c_ws,c_bday);
		
		if(c_sname != false && c_fname != false && c_mname != false && c_dept != false &&
