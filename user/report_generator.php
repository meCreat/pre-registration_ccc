...
if(isset($_SESSION['yr'])){
  $yr = mysqli_real_escape_string($conn, $_SESSION['yr']);
}

$course = '';
if(isset($_SESSION['course'])){
  $course = mysqli_real_escape_string($conn, $_SESSION['course']);
}
...
if(isset($_SESSION['status'])){
  $status = mysqli_real_escape_string($conn, $_SESSION['status']);
}

$active = '';
if(isset($_SESSION['active_status'])){
  $active = mysqli_real_escape_string($conn, $_SESSION['active_status']);
}

$classification = '';
if(isset($_SESSION['classification'])){
  $classification = mysqli_real_escape_string($conn, $_SESSION['classification']);
...
<div style="border:1px solid; margin:20px; padding:10px; border-radius:10px; background-color:    hsl(180, 100%, 99%);">
  ...
  <div style="margin-right: 20px; margin-left: 20px; padding-top: 20px; overflow-x: auto;">
    ...
    <form id="select" action="report_genEXCEL.php?<?=$link?>" method="POST">
    ...
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <div class="container">
            <form id="tbl" action="report_generate.php" method="POST">
  ...
  <div class="modal fade" id="location">
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <div class="container">
            <form id="submit1" action="report_genLoc.php" method="POST">
  ...
  <div class="modal fade" id="other">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <div class="container">
            <form id="others" action="report_genOthers.php" method="POST">
  ...
  <div class="modal fade" id="y_lvlModal">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <div class="container">
            <form id="submitYr" action="report_genYr.php" method="POST">
  ...
  <div class="modal fade" id="courseModal">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <div class="container">
          <form id="genCourse" action="report_genCourses.php" method="POST">
          <?php 
