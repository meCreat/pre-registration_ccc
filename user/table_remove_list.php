...
if (isset($_SESSION['dept'])) {
   ...
   $regLink .= '&dept='. mysqli_real_escape_string($conn, $_SESSION['deptGG']);
}

$course = '';
if (isset($_SESSION['course'])) {
   $course = ' AND course='. mysqli_real_escape_string($conn, $_SESSION['courseNG']);
   $regLink .= '&course='. mysqli_real_escape_string($conn, $_SESSION['courseNG']);
}
?>
...
<div class="row">
    <div class="col-md-2">
      ...
      <a id="excelBtn" href="excel_table_gen.php?graduating=0<?=$regLink?>" class="btn btn-success"><i class="bi bi-file-earmark-spreadsheet-fill"></i> Excel</a>
    ...
    <div class="float-right">
      ...
      <div class="float-right mr-4">
        <span>Status: </span>
      <form id="submit_reg" action="table_GnonG.php<?php if(isset($_GET['reg'])){echo '?reg='.$_GET['reg'];}?>" method='POST'>
      ...
      <div class="float-right mr-4" style="border: 1px solid black; padding: 5px">
        ...
        <form action="table_GnonG.php<?php if(isset($_GET['reg'])){echo '?reg='.$_GET['reg'];}?>" method="POST">
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <div class="container">
            <form id="submit" action="./fpdf/print_pdfGraduating&Non.php" method="POST" target='_blank'>
              <p>
