...
if (isset($_GET['course'])) {
  $code = 'AND courses.id ='.$_GET['course'];
  $head = $_GET['head'];
...
<div class="row">
    ...
    <form id="submit_y" action="table_dept&courseYear.php?abbD=<?php echo $_GET['abbD'];?>" method='POST'>
...
<div style="border:1px solid; margin:20px; padding:10px; border-radius:10px; background-color:    hsl(180, 100%, 99%);">
  ...
  <div class='' style="margin-right: 20px; margin-left: 20px; padding-top: 20px;">
    <form id="select" action="selected_st.php" method="POST" target="_blank">
