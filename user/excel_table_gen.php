...
if(isset($_GET['excel_ar_yr'])){
	$excel_ar_yr = " AND student_data.archive_year ='".$_GET['excel_ar_yr']."'";
	$excelArc.= $_GET['excel_ar_yr'];
}
...
$year_lvl = '';
if(isset($_GET['y_lvl'])){
	$year_lvl = 'AND student_data.year_lvl = '.$_GET['y_lvl'].'';
...
$dept = '';
if (isset($_GET['dept'])) {
	 $dept = 'AND program_dept.dept_id ='.$_GET['dept'];
	 $excel = $_GET['head']. ' Table';
}

$courses = '';
if (isset($_GET['course'])) {
	 $courses = 'AND courses.id ='.$_GET['course'];
	 $excel = $_GET['head']. ' Table';
}

$reg = '';
if (isset($_GET['reg'])) {
	$reg = "AND student_data.status ='".$_GET['reg']."'";
}
